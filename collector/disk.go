...
var diskIOCollector = Simple("disk_io", func(sink common.Sink) error {
...
func GetDiskUsage() ([]DiskUsage, error) {
	cmd := exec.Command("/bin/df", "--sync", "--output=source,target,fstype,file,itotal,iavail,iused,ipcent,size,avail,used,pcent")
...
var diskUsageCollector = Simple("disk_usage", func(sink common.Sink) error {
