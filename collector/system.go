...
var memoryCollector = Simple("memory", func(sink common.Sink) error {
...
var loadCollector = Simple("load", func(sink common.Sink) error {
...
var uptimeCollector = Simple("uptime", func(sink common.Sink) error {
